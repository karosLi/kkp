/*
** Lua binding: dispatch_lua
** Generated automatically by tolua++-1.0.93-lua53 on Fri Feb 25 16:32:57 2022.
*/
...
#ifndef TOLUA_DISABLE_tolua_dispatch_lua_dispatch_get_main_queue00
static int tolua_dispatch_lua_dispatch_get_main_queue00(lua_State* tolua_S)
{
...
#ifndef TOLUA_DISABLE_tolua_dispatch_lua_dispatch_get_global_queue00
static int tolua_dispatch_lua_dispatch_get_global_queue00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#ifndef TOLUA_DISABLE_tolua_dispatch_lua_dispatch_queue_create00
static int tolua_dispatch_lua_dispatch_queue_create00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#ifndef TOLUA_DISABLE_tolua_dispatch_lua_dispatch_queue_get_label00
static int tolua_dispatch_lua_dispatch_queue_get_label00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#ifndef TOLUA_DISABLE_tolua_dispatch_lua_dispatch_main00
static int tolua_dispatch_lua_dispatch_main00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#ifndef TOLUA_DISABLE_tolua_dispatch_lua_dispatch_async00
static int tolua_dispatch_lua_dispatch_async00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#ifndef TOLUA_DISABLE_tolua_dispatch_lua_dispatch_sync00
static int tolua_dispatch_lua_dispatch_sync00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#ifndef TOLUA_DISABLE_tolua_dispatch_lua_dispatch_after00
static int tolua_dispatch_lua_dispatch_after00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#ifndef TOLUA_DISABLE_tolua_dispatch_lua_dispatch_apply00
static int tolua_dispatch_lua_dispatch_apply00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#ifndef TOLUA_DISABLE_tolua_dispatch_lua_dispatch_once00
static int tolua_dispatch_lua_dispatch_once00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#ifndef TOLUA_DISABLE_tolua_dispatch_lua_dispatch_semaphore_create00
static int tolua_dispatch_lua_dispatch_semaphore_create00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#ifndef TOLUA_DISABLE_tolua_dispatch_lua_dispatch_semaphore_signal00
static int tolua_dispatch_lua_dispatch_semaphore_signal00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#ifndef TOLUA_DISABLE_tolua_dispatch_lua_dispatch_semaphore_wait00
static int tolua_dispatch_lua_dispatch_semaphore_wait00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#ifndef TOLUA_DISABLE_tolua_dispatch_lua_dispatch_time00
static int tolua_dispatch_lua_dispatch_time00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
TOLUA_API int tolua_dispatch_lua_open (lua_State* tolua_S)
{
 ...
 tolua_beginmodule(tolua_S,NULL);
  ...
  tolua_function(tolua_S,"dispatch_get_global_queue",tolua_dispatch_lua_dispatch_get_global_queue00);
  tolua_function(tolua_S,"dispatch_queue_create",tolua_dispatch_lua_dispatch_queue_create00);
  tolua_function(tolua_S,"dispatch_queue_get_label",tolua_dispatch_lua_dispatch_queue_get_label00);
  tolua_function(tolua_S,"dispatch_main",tolua_dispatch_lua_dispatch_main00);
  tolua_function(tolua_S,"dispatch_async",tolua_dispatch_lua_dispatch_async00);
  tolua_function(tolua_S,"dispatch_sync",tolua_dispatch_lua_dispatch_sync00);
  tolua_function(tolua_S,"dispatch_after",tolua_dispatch_lua_dispatch_after00);
  tolua_function(tolua_S,"dispatch_apply",tolua_dispatch_lua_dispatch_apply00);
  tolua_function(tolua_S,"dispatch_once",tolua_dispatch_lua_dispatch_once00);
  tolua_function(tolua_S,"dispatch_semaphore_create",tolua_dispatch_lua_dispatch_semaphore_create00);
  tolua_function(tolua_S,"dispatch_semaphore_signal",tolua_dispatch_lua_dispatch_semaphore_signal00);
  tolua_function(tolua_S,"dispatch_semaphore_wait",tolua_dispatch_lua_dispatch_semaphore_wait00);
 ...
 return tolua_dispatch_lua_open(tolua_S);
};
#endif
