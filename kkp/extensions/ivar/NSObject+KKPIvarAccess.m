...
#import "NSObject+KKPIvarAccess.h"
...
+ (KKPIvarInfo *)ivarInfoWithName:(NSString *)aName type:(NSString *)aType{
    KKPIvarInfo * obj = [[KKPIvarInfo alloc] initWithName:aName type:aType];
#if !__has_feature(objc_arc)
...
#pragma mark ///////////////////////////////////////////////////
@implementation NSObject (KKPIvarAccess)
...
- (NSArray *)getIvars {
	...
	for (unsigned int i = 0; i < count; i++) {
		...
		[infoObjects addObject:[KKPIvarInfo ivarInfoWithName:name type:type]];
	}
